...
internal struct Stemmer {
    ...
    static func stemmingWordsInText(_ text: String) async -> [String] {
        var stems: [String] = []
        ...
        await withCheckedContinuation { continuation in
            ...
            tagger.enumerateTags(in: range, scheme: .lemma, options: tagOptions) { (_, tokenRange, _, _) in
            ...
            continuation.resume(returning: stems)
        }
