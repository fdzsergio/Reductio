...
internal struct Stemmer {
    ...
    fileprivate static let language: Language = "en"
    fileprivate static let script: Script = "Latn"
    fileprivate static let orthography = NSOrthography(dominantScript: script, languageMap: [script : [language]])
